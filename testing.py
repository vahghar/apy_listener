...
if __name__ == "__main__":
    ...
    print("HyperLend: $0")
    print(f"Current Yield: $200,000 × 12.31% = ${200000 * 0.1231:,.2f}/year")
...
def recommended_move_amount_from_cron(cron_data: str, current_hyperfi_deposit: float = 200000) -> dict:
    """
